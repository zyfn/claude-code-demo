...
class Terminal:
    ...
    error: str | None = None
    turn_count: int = 0
    text: str = ""  # final text response (used by completed reason)

    # Convenience constructors
    @classmethod
    def completed(cls, turn_count: int, text: str = "") -> "Terminal":
        return cls(reason="completed", turn_count=turn_count, text=text)
