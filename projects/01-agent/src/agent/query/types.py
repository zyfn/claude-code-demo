"""Stream event types and chunk handling for the query loop.

These are the event types yielded by agent_loop(), consumed by
the caller (bootstrap/Agent, TUI, tests). No intermediate event bus.

Types:
- StreamEvent: Union of all public events
- ChunkAccumulator: accumulates streaming chunks
- handle_chunk: processes a single StreamingChatCompletionChunk
"""
