...
if TYPE_CHECKING:
    from src.agent.types import ChunkAccumulator
...
def handle_collapse_drain_retry(
    ...
    """
    # Stub: just reset the transition and continue
...
def handle_stop_hook_blocking(
    ...
    Stub: always returns (state, False) meaning "not blocked".
    Full implementation requires the stop hooks infrastructure.
    """
    return state, False
